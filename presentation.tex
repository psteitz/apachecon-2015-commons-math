...
\begin{itemize}
  ...
  \item Dfp (arbitrary precision arithmentic)
...
\begin{description}
  \item[Optimization, Algebra & Geometry] optim, linear, fitting, ode, transform, geometry 
\end{description}
...
\begin{small}  
\begin{description}
  \item[First problem] escape to NaN
\end{description}
\begin{itemize}
  ...
  \item Result: do not really try to compactify; use standard definitions
and let chips fall where they may
\end{itemize}
\begin{description}
  \item[Second problem] hanging
\end{description}
\begin{itemize}
  \item Ongoing debate about what to make defaults, whether to have defaults for number of
function evaluations, function value accuracy, etc...
